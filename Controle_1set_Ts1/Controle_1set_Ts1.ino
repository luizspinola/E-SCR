...
int sampleTime_temp = 1000;
int sampleTime_fluxo = 400;

float temp1 = 25.0, temp2 = 25.0, temp3 = 25.0, mediatemp = 25.0;
...
void loop() {
  ...
  if ((cont_fluxo>=3900)&&(j<1))
  { 
    j++;
    cont_fluxo = 0;
  }

  //if ((cont_temp>=2000)&&(i<2))
  //{ 
  //  i++;
  //  cont_temp = 0;
  //}
